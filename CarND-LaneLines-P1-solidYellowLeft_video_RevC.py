...
def process_image(image):
        ...
        # Draw lines 
        draw_lines(image, masked_edges, hough_lines_process.rho, hough_lines_process.theta, hough_lines_process.threshold,
                        hough_lines_process.min_line_length, hough_lines_process.max_line_gap) 
        return image    
